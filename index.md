...
This journal documents the implementation and configuration of a secure Linux server infrastructure across 7 weeks.
...
**Architecture**: Dual VM setup (Ubuntu Server 24.04 LTS + Linux Mint 22)  
